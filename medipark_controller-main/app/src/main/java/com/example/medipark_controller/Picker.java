...
public class Picker extends LinearLayout {
         ...
         */
        private static int DEFAULT_WHEEL_ITEM_COUNT = 7;
        ...
        public interface OnValueChangeListener {
             ...
             */
            void onValueChange(Picker picker, int oldVal, int newVal);
        }
        ...
        public interface OnScrollListener {
            ...
            public void onScrollStateChange(
                    ...
                    Picker view, @ScrollState int scrollState);
        }
        ...
        public Picker(Context context, AttributeSet attrs, int defStyle) {
            ...
            inflater.inflate(R.layout.picker_material, this, true);
         ...
         * <p>
         * If the argument is less than the {@link Picker#getMinValue()} and
         * {@link Picker#getWrapSelectorWheel()} is <code>false</code> the
         * current value is set to the {@link Picker#getMinValue()} value.
         * </p>
         * <p>
         * If the argument is less than the {@link Picker#getMinValue()} and
         * {@link Picker#getWrapSelectorWheel()} is <code>true</code> the
         * current value is set to the {@link Picker#getMaxValue()} value.
         * </p>
         * <p>
         * If the argument is less than the {@link Picker#getMaxValue()} and
         * {@link Picker#getWrapSelectorWheel()} is <code>false</code> the
         * current value is set to the {@link Picker#getMaxValue()} value.
         * </p>
         * <p>
         ...
         * wrap around the {@link Picker#getMinValue()} and
         * {@link Picker#getMaxValue()} values.
         * <p>
    ...
    //        }
        ...
        public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
            ...
            event.setClassName(Picker.class.getName());
        ...
        //custom methods
        public String[] displayedDatas;
        public final float normalTextSize=42.0f;
        public final float selectedTextSize=67.0f;


        public void initPicker(Activity activity,int soundFileId, String[] displayedDatas){

            //setTextSize for all TextView in Picker
            setTextSize(normalTextSize);
            setSelectedTextSize(selectedTextSize);
            setDividerColor(Color.WHITE);
            setScrollingSound(activity,soundFileId);
            setDisplayedDatas(displayedDatas);
        }



        public void setScrollingSound(Activity activity, int fileId){
                this.setOnValueChangedListener(new Picker.OnValueChangeListener() {
                        @Override
        ...
        public void setDisplayedDatas(String[] datas){
                displayedDatas=datas;
                setMinValue(0);
                setMaxValue(datas.length-1);
                setDisplayedValues(datas);
        }



        public void setItemCount(int count){
                this.DEFAULT_WHEEL_ITEM_COUNT=count;
        }
}